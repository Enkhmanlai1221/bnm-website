...
export function CentralMongolia() {
  const destinations = [
    { name: "Khogno Tarna NP", image: "/khongoo.png", size: "wide" },
    { name: "Ugii Lake", image: "/ugii.png", size: "medium" },
    { name: "Tuvkhun Monastery", image: "/tuvkhun.png", size: "medium" },
    { name: "Ulaan Tsutgalan", image: "/ulana.png", size: "tall" },
    { name: "Kharkhorin", image: "/kharkhorin.png", size: "wide" },
    { name: "Tsenkher Hot Springs", image: "/tsenkher.png", size: "medium" },
    { name: "Khuisiin Naiman Lake", image: "/khuisiin.png", size: "medium" },
    { name: "Terkhiin Tsagaan Lake", image: "/terkhiin.png", size: "wide" },
    { name: "Tsetserleg City", image: "/tsetserleg.png", size: "medium" },
    { name: "Taikhar Rock", image: "/taikhar.png", size: "medium" },
    { name: "Chuluut Valley", image: "/chuluut.png", size: "medium" },
    { name: "Khujirt", image: "/khujirt.png", size: "medium" },
  ];
