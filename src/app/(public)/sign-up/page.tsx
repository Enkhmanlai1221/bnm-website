...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center p-4">
      <div className="absolute left-0 top-0 w-96 h-96 bg-blue-200 rounded-full opacity-20 -translate-x-48 -translate-y-48"></div>
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 relative z-10 animate-fade-in-up">
        ...
        <div className="flex justify-center space-x-4 mb-6">
          <button className="w-12 h-12 bg-white border border-gray-300 rounded-full flex items-center justify-center hover:bg-gray-50 transition-colors transform hover:scale-105">
